...
public class AdminController {
    ...
    public AdminController(
            ...
            InstructorRepository instructorRepository, EmailService emailService) {
    ...
    public ResponseEntity<ApiResponseDto<MessageDTO>> rejectInstructor(@PathVariable("id") int id) {
    ...
    public ResponseEntity<ApiResponseDto<MessageDTO>> approveInstructor(@PathVariable("id") int id) {
